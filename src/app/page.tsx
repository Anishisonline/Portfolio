...
export default async function Home() {
  ...
  const { user } = userData as UserObject;
  ...
  return (
    <main className="relative">
      <Transition className="fixed md:top-8 top-6 md:left-8 left-6 z-30 hover:text-white/80 text-white/40">
        <Link href={"/"}>
          <TextReveal className="font-semibold ">Anish Kumar</TextReveal>
        </Link>
      </Transition>
      ...
      <section className="px-2 py-20 relative" id="services">
        ...
        <SectionHeading className="md:pl-16 overflow-hidden">
          <SlideIn className="text-white/40">Education</SlideIn> <br />
          <SlideIn>Background</SlideIn>
        </SectionHeading>
